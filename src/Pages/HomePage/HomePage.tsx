...
const HomePage: React.FC<HomePageProps> = ({ username, onLogout }) => {
    ...
    return (
        <div className="home-container">
            <header className="home-header">
                <div className="header-content">
                    ...
                    <div className="s-header-content">
                        <button
                            className={`section-button ${activeButton === 0 ? "active-button" : ""}`}
                        ...
                        <button
                            className={`section-button ${activeButton === 1 ? "active-button" : ""}`}
                        ...
                        <button
                            className={`section-button ${activeButton === 2 ? "active-button" : ""}`}
                        ...
                        <button
                            className={`section-button ${activeButton === 3 ? "active-button" : ""}`}
                        ...
                        <button
                            className={`section-button ${activeButton === 4 ? "active-button" : ""}`}
                        ...
                        <button
                            className={`section-button ${activeButton === 5 ? "active-button" : ""}`}
                        ...
                        <button
                            className={`section-button ${activeButton === 6 ? "active-button" : ""}`}
                            onClick={() => {
                                handleButtonClick(6)
                                handleClienteApi()
                            }}
                        ...
                        <div className="settings-button-container" ref={settingsRef}>
                            <button
                                className={`section-button ${activeButton === 7 ? "active-button" : ""}`}
                                onClick={() => {
                                    handleButtonClick(7)
                            ...
                            {showSettingsPopout && (
                                <div className="settings-popout">
                                    <div className="settings-popout-content">
                        ...
                        <button
                            className={`section-button ${activeButton === 8 ? "active-button" : ""}`}
                            onClick={() => {
                                handleButtonClick(8)
                                onLogout()
                            }}
            ...
            <main className="home-content-services">
                <div className="">
